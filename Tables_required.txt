...
$create_table_AC="
CREATE TABLE IF NOT EXISTS ACtb(
...
//For Project Guide
$create_table_PG="
CREATE TABLE IF NOT EXISTS PGtb(
...
//For Guest Faculty
$create_table_GF="
CREATE TABLE IF NOT EXISTS GFtb(
...
$create_table_JF="
CREATE TABLE IF NOT EXISTS JFTb(
...
//OFS TAble
$create_table_OFS="
CREATE TABLE IF NOT EXISTS OFSTb(
...
//LBA
$create_table_LBA="
CREATE TABLE IF NOT EXISTS LBATb(
...
//CONT
$create_table_Cont="
CREATE TABLE IF NOT EXISTS ConTb(
...
//BOK
$create_table_BOK="
CREATE TABLE IF NOT EXISTS BokTb(
...
//LAB
$create_table_LAB="
CREATE TABLE IF NOT EXISTS LabTb(
